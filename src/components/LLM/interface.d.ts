...
export interface LLMActions {
    ...
    finetune: (index: number) => void;
    chat: (index: number) => void;
}
 ...
 * LLM 分页参数
 */
export interface LLMPagination {
    /** 每页数量 */
    limit: number;
    /** 当前页 */
    page: number;
...
export interface LLMProp {
    ...
    /** 接口字段映射 */
    apiKeyMap?: LLMAPIKeyMap;
    /** 表格列配置 */
    columns: LLMColumn<any>[];
    /** 表格数据 */
...
export type {FormModelItem, FormModel, LLMActions, LLMAPIKeyMap, LLMColumn, LLMPagination, LLMProp };
