 ...
 * 表格列配置
 */
export interface TaskEditColumn {
    label: string;
    prop: string;
    /** 是否可编辑 */
    edit?: boolean;
...
export interface TaskAPIKeyMap {
    /** 查询时的当前页 key 值 */
...
export interface TaskProp {
    ...
    /** 接口字段映射 */
    apiKeyMap?: ProjectAPIKeyMap;
    /** 表格列配置 */
    columns: ProjectEditColumn<any>[];
    /** 表格数据 */
...
export type {FormModelItem, FormModel, TaskActions, TaskAPIKeyMap,
    TaskEditColumn, TaskPagination, TaskProp };
